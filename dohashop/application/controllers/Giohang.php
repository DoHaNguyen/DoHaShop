...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='DoHaSHOP - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='DoHaSHOP - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Công ty kinh doanh sản phẩm DoHaSHOP');
        ...
        $this->data['title']='DoHaSHOP.vn - Kết quả đơn hàng';
