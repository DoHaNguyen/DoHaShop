...
class Dangnhap extends CI_Controller {
    ...
    public function dangnhap(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $this->data['title']='DoHaSHOP - Đăng nhập tài khoản';
            $this->data['view']='dangnhap';
            $this->load->view('frontend/layout',$this->data);
        }     
    }
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['smtp_user']    = 'nguyendoha23@gmail.com';
            $config['smtp_pass']    = 'idpfmftguqydlflg';
            ...
            $this->email->from('nguyendoha23@gmail.com', 'DoHaSHOP');
            $this->email->to($email);
            $this->email->subject('DoHaSHOP - Quà thành viên mới');
            $this->email->message('Bạn đã trở thành thành viên mới của cửa hàng DoHaSHOP, Cửa hàng tặng bạn 1 mã giảm giá giảm 100.000 đ : '.$tempcoupon.' , Mã này có giá trị tới ngày '.$tempdatelimit.'
        ...
        $this->data['title']='DoHaSHOP - Đăng ký tài khoản';
    ...
    public function forget_password(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $this->email->subject('DoHaSHOP - Lấy lại mật khẩu');
        ...
        $this->data['title']='DoHaSHOP - Quên mật khẩu';
    ...
    public function reset_password_new($id){
        ...
        if($this->form_validation->run() ==TRUE){ 
           ...
           if($this->Mcustomer->customer_check_id_email($id, $email)!=FALSE){
            ...
            $this->data['title']='DoHaSHOP - Cập nhật mật khẩu mới';
