<section id="menu-slider">
    <div class="slider">
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
                <img style="width: 100%; height: 160px;" src="public/images/6.png">
                <img style="width: 100%; height: 160px;" src="public/images/5.jpg">
            </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="sale-title">
            <span><img src="http://localhost/dohashop/public/images/hot.gif" alt=""> KHUYẾN MÃI HOT <img
                        src="http://localhost/dohashop/public/images/hot.gif" alt=""></span>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="sale-title">
            <span><img src="http://localhost/dohashop/public/images/hot.gif" alt=""> SẢN PHẨM BÁN CHẠY NHẤT <img
                        src="http://localhost/dohashop/public/images/hot.gif" alt=""></span>
        </div>
    </div>
    <div class="container" style="margin-bottom: 20px;">
            ...
            if ((count($listProducts) >= 3)):?>
                <div class="list-product">
                    <div class="list-header-z">
                        <h2><a href="<?php echo $rowCategory['link'] ?>"> <img
                                        src="http://localhost/dohashop/public/images/hot.gif"
                                        alt=""> <?php echo $rowCategory['name'] ?> nổi bật <img
                                        src="http://localhost/dohashop/public/images/hot.gif" alt=""></a></h2>
                        <b>
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue"><img src="http://localhost/organic/upload/icon/hot.gif"
                                                               alt=""> Tin tức <img
                            src="http://localhost/organic/upload/icon/hot.gif" alt=""></h2>
            </div>
        </div>
...
<div class="bottom_support" style="z-index:999px;">
    <div class="wrap_bottom">
        <div class="hotline_bottom"><span class="ico"><img
                        src="https://1.bp.blogspot.com/-2t8Fkz-XcxY/V34e6T2c2zI/AAAAAAAAFTU/TljIpi_TLjs1HttVtsWB-mEsS1fPrAhpwCLcB/s1600/bottom_support_ico_phone.png"/></span>
            <div class="txt">Hotline:<strong>036.999.0606 - </strong> <span>(Email)</span>:
                <span>Nguyendoha23@gmail.com</span></div>
        </div>
        <div class="guide_payment"><a target="_blank" href="http://localhost/dohashop/tin-tuc/huong-dan-thanh-toan">
                <span class="ico"><img
                            src="https://4.bp.blogspot.com/-HcT7Kt4C8VA/V34fL1DNrWI/AAAAAAAAFTc/UI3fSHd7TesOTyf94TjnShxvy8quhImLACLcB/s1600/bottom_support_ico_guidepayment.png"/></span>
                <span class="txt">Hướng dẫn thanh toán</span> </a></div>
        <div class="advisory_online"><a target="_blank" href="https://www.facebook.com/doha.nguyendoha"> <span
                        class="ico"><img
                            src="https://2.bp.blogspot.com/-C5F14CaOBhc/V34fL7_9p8I/AAAAAAAAFTY/QaXidsUV5xk_GaKaDZY8XW2lHMNT0XUkwCLcB/s1600/bottom_support_ico_advisoryonline.png"/></span>
                <span class="txt">Tư vấn online</span> </a></div>
    </div>
</div>
<style type="text/css">
    ...
    @media screen and (max-width: 720px) {
        .bottom_support a, .bottom_support .hotline_bottom {
            font-size: 13px
        }
    ...
    @media screen and (max-width: 560px) {
        ...
        .bottom_support .hotline_bottom, .bottom_support .hotline_bottom span {
            font-size: 10px
        }
        ...
        .bottom_support .guide_payment .txt, .bottom_support .advisory_online .txt {
            margin-left: 15%
        }
    }
    ...
    @media screen and (max-width: 400px) {
        .bottom_support a, .bottom_support .hotline_bottom, .bottom_support .hotline_bottom span {
            font-size: 9px
        }
