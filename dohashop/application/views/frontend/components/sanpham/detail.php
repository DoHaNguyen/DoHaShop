					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Mua từ 5 mặt hàng tổng giá trị 1.000.000đ sẽ được tặng mã giảm giá 50.000đ <br/> <a href="https://www.facebook.com/doha.nguyendoha/" target="_blank">Liên hệ</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>ĐẶC TÍNH</b>
								<br>
								<span>Công ty chúng tôi được những thương hiệu hàng đầu EU hợp tác, Hoàn toàn đảm bảo chất lượng sản phẩm </span>
							</div>
							<div style="margin-top: 20px;">
								<b>CHẤT LƯỢNG</b>
								<br>
                                <span>Đỗ Hà Shop đã đạt được nhiều chứng nhận quốc tế và là cơ sở được nhiều nhãn hàng từ Liên minh châu Âu ủy quyền</span>
							</div>
						</div>
					</div>
